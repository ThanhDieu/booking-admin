...
import { BundleListResult } from 'pages/@booking/ReservationsPage/partials';
...
import { triggerSendCampaignThunk } from 'store/booking/Mailchimp/thunks';
...
const CreateNewsletter = () => {
  ...
  const { properties, loading } = useAppSelector((state) => state.booking.property);
