...
import { BundleListResult, FormSearchBundle } from 'pages/@booking/ReservationsPage/partials';
import React, { useEffect, useState } from 'react';
import { useTranslation } from 'react-i18next';
import { getBundlesService } from 'services/Bundle';
import { BundleListType } from 'services/Bundle/type';
import { useAppSelector } from 'store';
import { StateAccommodation } from 'store/booking/Booking';
...
const ChooseBundle = ({ setCurrentStep }: Props) => {
  ...
  const { stateAccommodation, payloadSearch } = useAppSelector((state) => state.booking.booking);
