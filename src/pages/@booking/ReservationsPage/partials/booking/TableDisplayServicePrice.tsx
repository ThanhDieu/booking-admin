...
import { addReservation, updateExtraServices } from 'store/booking/Booking';
import { updateExtraServiceOffer } from 'store/booking/Offer';
...
const TableDisplayServicePrice = ({
  ...
  const { extraServiceOffer } = useAppSelector((state) => state.booking.offer);
